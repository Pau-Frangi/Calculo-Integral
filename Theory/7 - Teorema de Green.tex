...
\ejemplo{
    Sea el campo vectorial $F(x,y) = \left(\frac{-y}{x^2 + y^2}, \frac{x}{x^2 + y^2}\right)$ y el camino dado por $\gamma(t) = (\varepsilon\cos(2\pi t), \varepsilon\sin(2\pi t))$ con $t \in [0,1]$ y $\varepsilon > 0$. \\
    ...
    $$\int_{\gamma} F = \int_{t=0}^{t=1} \langle F(\gamma(t)), \gamma'(t) \rangle dt = \int_{t=0}^{t=1} \left\langle \left(\frac{-\varepsilon\sin(2\pi t)}{\varepsilon^2}, \frac{\varepsilon\cos(2\pi t)}{\varepsilon^2}\right), \left(-2\pi\varepsilon\sin(2\pi t), 2\pi\varepsilon\cos(2\pi t)\right) \right\rangle dt$$
