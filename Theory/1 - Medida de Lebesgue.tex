...
\begin{proof}
    ...
    \]
    Por tanto $y \in B_{\infty}(x, \delta) \implies x \in \overline{B}_{\infty}(q, r) \subset G$. Luego $G = \bigcup_{B \in \mathcal{B}}B$.\\
    Nótese que numerabilidad de la familia $\mathcal{B}$ es inmediata por la numerabilidad de $\Q^n$ que, a su vez, es numerable por ser $\Q$ numerable.\\
    La segunda parte del teorema es análoga a la primera.
\end{proof}
...
\definicion{
    ...
    con $m \in \mathbb{Z} \text{(nivel de escala u orden) y } k_1, k_2, \dots k_n \in \mathbb{Z}$
}
...
\begin{proposición}
    ...
    \begin{enumerate}
        ...
        \item si $A, B$ son conjuntos medibles y disjuntos y $f\geq 0 \implies \int_{A \cup B} f = \int_A f + \int_B f$.
