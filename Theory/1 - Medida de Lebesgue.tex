...
\ejemplo{
    ...
    $$ = \frac{1}{2} \int_{u = 0}^{u = 2}(\int_{u = -v}^{u = v}e^{\frac{u}{v}}du)dv = \frac{1}{2} \int_{v = 0}^{v = 2}[v e^{\frac{u}{v}}]_{u = -v}^{u = v} dv = \frac{1}{2} \int_{v = 0}^{v =2}v(e-\frac{1}{e})dv = \frac{1}{2}(e-e^-1)[\frac{v^2}{2}]_{v = 0}^{v=2} = e - e^-1$$
}
