...
\ejemplo{
    \begin{enumerate}
        ...
        Intentemos calcular
        $$\int_D x^2y \,dx\,dy = \int_{\mathbb{R}^2} x^2y \cdot \chi_D \,dx\,dy = \int_{x = -\infty}^{x = +\infty}(\int_{D_x}x^2\chi_Ddy)dx = $$
        Sabiendo que $D_x = \{y \in \mathbb{R} : (x,y) \in D\}$, si $0 \leq x \leq 2$ entonces $D_x = \{y : -\frac{1}{2}x + 1 \leq y \leq \frac{1}{2}x+1\}$.\\
        Por tanto, podemos plantear la integral como:  
        $$= \int_{x = 0}^{x =2} \left( \int_{y = -\frac{1}{2}x + 1}^{y = \frac{1}{2}x + 1} x^2y \,dy \right) dx  = \int_{0}^{2}x^2\left(\frac{1}{2}x + 1 + \frac{1}{2}x - 1\right)dx = \int_{0}^{2}x^3dx = \frac{16}{4} = 4.$$\\  
        También podríamos haberlo planteado así, sabiendo que $D^y = \{x : (x,y) \in D\}$:
...
>>>>>>> f31427a45fcee29e2565029be6f1c5657572e2dd
