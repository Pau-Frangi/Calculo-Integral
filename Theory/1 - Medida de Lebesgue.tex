    ...
    \begin{itemize}
        ...
        \item Para la región $A = \{(x,y) : x^2 + y^2 \leq 1, \, y \geq 0\}$ con $f(x,y) =
                  \sqrt{x^2+y^2}$: $$ \int_{A} f(x,y) \, dx \, dy = \int_{\theta = 0}^{\theta =
                      \pi} \left( \int_{r = 0}^{r = 1} r \cdot r \, ( \text{Jacobiano} ) \, dr
                  \right) d\theta. $$ Resolviendo: $$ \pi \cdot \int_{r = 0}^{r = 1} r^2 \, dr =
                  \frac{\pi}{3}. $$
    \end{itemize}
}
...
Elevando al cuadrado y sumando ambas ecuaciones, obtenemos: $$ \frac{x^2}{a^2}
    + \frac{y^2}{b^2} = r^2. $$ De aquí, podemos despejar $r$ en función de $x$ y
$y$: $$ r = \frac{1}{\sqrt{\frac{x^2}{a^2} + \frac{y^2}{b^2}}}. $$

Estas coordenadas permiten describir puntos en el plano $(x,y)$ de forma
natural para regiones con simetría elíptica.
\end{definición}
...
\ejemplo{
    ...
    \[
        \frac{1}{2} \text{area}(E) = \frac{1}{2} \cdot 32 = 16
    \]
}
...
$$ = 2\int_{0}^{2\pi} \left[-\frac{1}{3}(a^2-r^2)^{\frac{3}{2}}\right]^{r = a\sin(\theta)}_{r = 0} d\theta = \frac{2}{3} \int_{\theta = 0}^{\theta = \pi} a^3 - (a^2 - a^2\sin^2(\theta))^{\frac{3}{2}}d\theta$$
$$= \frac{2}{3}\int_{\theta = 0}^{\theta = \pi} a^3 - a^3|\cos^3(\theta)|d\theta = 4 \frac{a^3}{3}\int_{0}^{\theta = \frac{\pi}{2}} 1- \cos^3(\theta)d\theta = \frac{4\pi a^3}{3}(\frac{\pi}{2} - \frac{2}{3})$$
