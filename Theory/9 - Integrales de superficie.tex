...
$$ a(S) = \int_{D} \lVert \vec{N}_\varphi \rVert dudv = \int_{\theta = 0}^{\theta = 2\pi} \int_{z = 1}^{z = 2} z\sqrt{2} dz d\theta = \int_{\theta = 0}^{\theta = 2\pi} \left[ \frac{z^2}{2}\sqrt{2} \right]_{z = 1}^{z = 2} d\theta $$
...
\ejemplo{
    ...
    $$ \int_{S} f dS = \int_{D} f(\varphi(\theta,z)) \lVert \vec{N}_\varphi \rVert d\theta dz = \int_{\theta = 0}^{\theta = 2\pi} \int_{z = 1}^{z = 2} 2z^2 \cdot z\sqrt{2} dz d\theta = \int_{\theta = 0}^{\theta = 2\pi} \frac{2\sqrt{2}}{4} \left[ z^4 \right]_1^2 \, d\theta $$
    $$= \int_{\theta = 0}^{\theta = 2\pi} \frac{2\sqrt{2}}{4} (16 - 1) \, d\theta = \int_{\theta = 0}^{\theta = 2\pi} \frac{30\sqrt{2}}{4} \, d\theta = \int_{\theta = 0}^{\theta = 2\pi} \frac{15\sqrt{2}}{2} \, d\theta = \frac{15\sqrt{2}}{2} \cdot (2\pi) = 15\pi\sqrt{2}$$
...
$$ a(S) = \int_{D} \lVert \vec{N}_\varphi \rVert dudv = \int_{\theta = 0}^{\theta = 2\pi} \int_{\phi = 0}^{\phi = \pi} R^2 \sin(\phi) d\phi d\theta = \int_{\theta = 0}^{\theta = 2\pi} \left[ -R^2 \cos(\phi) \right]_{\phi = 0}^{\phi = \pi} d\theta $$
...
\begin{definición} [Área de una Superficie]
