...
\ejemplo{
    ...
    De forma alternativa se podría haber visto que $\vec{F}$ es un campo conservativo, buscando una funcion $\varphi$ tal que $\vec{F} = \nabla \varphi$, es decir: 
    \begin{enumerate}
...
\begin{observación}
    ...
    \begin{itemize}
        \item Una forma diferencial de orden 1 en $U$ es una expresión de la forma $\omega = Pdx + Qdy$ con $P, Q$ de clase $C^1$ en $U$. 
