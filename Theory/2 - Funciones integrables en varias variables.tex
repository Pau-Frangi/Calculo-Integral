...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \int_E f \leq \int_E g.
        \]
        \item  Consideremos funciones simples \( s, t \) tales que \( 0 \leq s \leq f \cdot \chi_E \) y \( 0 \leq t \leq g \cdot \chi_E \). Como \( s+t \) es también una función simple y satisface \( 0 \leq s + t \leq (f+g) \cdot \chi_E \), tenemos:
